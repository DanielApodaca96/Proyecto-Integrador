...
<nav class="col-md-2 col-sm-3 leftPane2">
  ...
  <ul class="nav nav-pills nav-stacked">
    <li role="presentation"><a href="./index.blade.php"><i class="fas fa-home padRight"></i>Inicio</a></li>
    <li role="presentation"><a href="#"><i class="fas fa-users padRight"></i>Grupos</a></li>
    <li role="presentation"><a href="#"><i class="fas fa-book padRight"></i>Talleres</a></li>
